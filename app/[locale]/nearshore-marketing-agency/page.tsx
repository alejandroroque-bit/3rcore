    ...
    <>
      ...
      <main>
        ...
        <SEOContentBlock
          ...
          paragraphs={6}
          relatedLinks={[{ href: "/servicios/ugc", label: "UGC Content" }, { href: "/servicios/influencer-marketing", label: "Influencer Marketing" }, { href: "/servicios/google-ads", label: "Google Ads" }, { href: "/posicionamiento-seo", label: "SEO" }]}
        />
        <ReviewsSection/>
        <ClientSection />
        <ContactAnchor>
