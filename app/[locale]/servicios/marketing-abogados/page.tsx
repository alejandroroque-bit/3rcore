...
export default function MarketingAbogados() {
  ...
  return (
    <>
      ...
      <main>
        <h1 className="sr-only">{tH1('abogados')}</h1>
        <div id="hero">
          <ServiceLanding namespace="MarketingAbogadosLanding" />
        </div>
        <ServiceFAQ namespace="MarketingAbogadosFAQ" count={8} />
        <SEOContentBlock
