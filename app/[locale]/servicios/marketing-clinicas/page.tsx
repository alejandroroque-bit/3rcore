    ...
    <>
      ...
      <main>
        ...
        <SEOContentBlock
          ...
          paragraphs={6}
          relatedLinks={[{ href: "/servicios/google-ads", label: "Google Ads" }, { href: "/servicios/meta-ads", label: "Meta Ads" }, { href: "/posicionamiento-seo", label: "SEO Local" }, { href: "/servicios/web-development", label: "Landing Pages" }]}
        />
        <ReviewsSection/>
        <ClientSection />
        <ContactAnchor>
