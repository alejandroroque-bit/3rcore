...
export default function MarketingEcommerce() {
  ...
  return (
    <>
      ...
      <main>
        <h1 className="sr-only">{tH1('ecommerce')}</h1>
        <div id="hero">
          <ServiceLanding namespace="MarketingEcommerceLanding" />
        </div>
        <ServiceFAQ namespace="MarketingEcommerceFAQ" count={8} />
        <SEOContentBlock
