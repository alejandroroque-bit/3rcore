...
export default function PerformanceMarketing() {
  ...
  return (
    <>
      ...
      <main>
        <h1 className="sr-only">{tH1('performance')}</h1>
        <div id="hero">
          <ServiceLanding namespace="PerformanceLanding" />
        </div>
        <ServiceFAQ namespace="PerformanceFAQ" count={8} />
        <SEOContentBlock
          namespace="PerformanceSEO"
          paragraphs={6}
          relatedLinks={[{ href: "/servicios/google-ads", label: "Google Ads" }, { href: "/servicios/meta-ads", label: "Meta Ads" }, { href: "/servicios/tiktok-ads", label: "TikTok Ads" }, { href: "/posicionamiento-seo", label: "SEO" }]}
        />
        <ReviewsSection/>
        <ClientSection />
        <ContactAnchor>
