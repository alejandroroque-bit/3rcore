...
export default function PosicionamientoIA() {
  ...
  return (
    <>
      ...
      <main>
        <h1 className="sr-only">{tH1('posicionamientoia')}</h1>
        <div id="hero">
          <ServiceLanding namespace="PosicionamientoIALanding" />
        </div>
        <ServiceFAQ namespace="PosicionamientoIAFAQ" count={8} />
        <SEOContentBlock
          namespace="PosicionamientoIASEO"
          paragraphs={6}
          relatedLinks={[{ href: "/posicionamiento-seo", label: "SEO" }, { href: "/servicios/web-development", label: "Desarrollo web" }, { href: "/precios", label: "Precios" }, { href: "/cotizar", label: "Cotizador" }]}
        />
        <ReviewsSection/>
        <ClientSection />
        <ContactAnchor>
