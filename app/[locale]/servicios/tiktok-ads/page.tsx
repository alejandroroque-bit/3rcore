...
export default function TikTokAds() {
  ...
  return (
    <>
      ...
      <main>
        <h1 className="sr-only">{tH1('tiktokads')}</h1>
        <div id="hero">
          <ServiceLanding namespace="TikTokAdsLanding" />
        </div>
        <ServiceFAQ namespace="TikTokAdsFAQ" count={8} />
        <SEOContentBlock
          namespace="TikTokAdsSEO"
          paragraphs={6}
          relatedLinks={[{ href: "/servicios/meta-ads", label: "Meta Ads" }, { href: "/servicios/google-ads", label: "Google Ads" }, { href: "/servicios/performance-marketing", label: "Performance Marketing" }, { href: "/servicios/socialmedia", label: "Redes Sociales" }]}
        />
        <ReviewsSection/>
        <ClientSection />
        <ContactAnchor>
