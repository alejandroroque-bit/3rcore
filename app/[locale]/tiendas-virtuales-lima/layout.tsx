...
export async function generateMetadata({ params }: { params: any }): Promise<Metadata> {
  ...
  return generatePageMetadata({
    ...
    titleEn: 'Shopify & WooCommerce Store Development for U.S. Brands | 3R Core',
    ...
    descriptionEn: 'We build your online store on Shopify or WooCommerce with payment gateway, loaded catalog, tax setup and technical SEO. Bilingual storefronts ready to sell in the U.S. From $1,750.',
